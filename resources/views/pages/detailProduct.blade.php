...
$(document).ready(function() {
    ...
    $('.quantity-right-plus').click(function(e) {
        ...
        var maxProduct = $('#quantity').attr('max');
        // If is not undefined
                    ...
                    <div class="product-information">
                        ...
                        <div class="product-price">
                            ...
                            <div class="product-price-old" style="font-size: 15px;">
                                {{number_format($detailProduct->product_price , 0, ',', '.') }}₫</div>
                            ...
                            <div style="width: 100%;display: flex;align-items: center;margin: 30px 0;">
                                ...
                                <div class="input-button-group">
                                    ...
                                    <input type="text" id="quantity" name="quantity" class="input-number" value="1"
                                        min="1" max="{{$detailProduct->product_stock}}">
                                ...
                                <div style="display: flex;  color: #757575;margin-left: 30px;" class="quantity-product">
                                    <span style='padding-right: 5px;'>{{$detailProduct->product_stock}} </span>sản phẩm
                                    có sẵn
                                </div>
                            </div>
...
<div class="container" style="background-color: white; margin-top: 20px;padding: 20px;">
    <div style="width: 100%;">
        <h1 class="title" style="width: 100%; font-size: 20px;color: black;  text-transform: uppercase;">

...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('role.update',['id'=>$role->role_id])}}" style="width: 100%" method="post"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('role_display_name') is-invalid @enderror"
                                id="name" name="role_display_name" placeholder="Nhập tên vai trò"
                            ...
                            <div class="card-body" style="display: flex; justify-content: space-between;">
                                ...
                                <label class="custom-control custom-checkbox overflow-checkbox">
                                    <input type="checkbox" value="{{ $item->pms_id }}"
                                        ...
                                        {{ $permissionChecked->contains('pms_id',$item->pms_id) ? 'checked' : '' }}>
                                    <span
